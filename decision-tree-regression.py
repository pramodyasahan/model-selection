...
regressor = DecisionTreeRegressor(random_state=0)  # random_state=0 for reproducibility

# Fitting (training) the Decision Tree Regressor model on the training data
